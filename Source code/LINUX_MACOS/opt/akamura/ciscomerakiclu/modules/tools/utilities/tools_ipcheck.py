...
def get_ip_details(ip_address, handler):
    ...
    try:
        ...
        # Organize data into a list for Rich table, checking for attribute existence
        ip_info = [
        ...
        if domains != 'N/A':  # Only add domain details if they are available
...
def main(db_password):
    ...
    # Ask for the IP address from the user
